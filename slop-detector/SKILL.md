...
- **French typography is not slop.** A non-breaking space before `:` `;` `!` `?` and inside « » is *correct* French. Never flag it. The Spanish dialogue raya (—) is correct per the RAE. The pre-screen guards these; you must too.
