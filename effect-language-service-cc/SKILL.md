...
description: >
  ...
  decisions about Effect adoption (use effect-ts), non-Effect TypeScript, or manual code
...
For architecture decisions about when/how to use Effect, see the `effect-ts` skill (Effect-TS/skills) instead.
...
| Pattern guidance | Load `effect-ts` skill |
